...
* var 15
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.fbcf, lags(1/5)
* var 16
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario, lags(1/3)
* var 17
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario, lags(1/4)
* var 18
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario, lags(1/5)
* var 19
qui var D1.rgdp D1.pib D1.primario, lags(1/5)
* var 20
qui var D1.rgdp D1.pib D1.primario, lags(1/4)
* var 21
qui var D1.rgdp D1.pib D1.primario, lags(1/3)


* period1: 2013Q2
* h =1 
* VAR 54:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.fbcf if qdate<tq(2013Q2), lags(1/5)
...
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2013Q2), lags(1/3)
...
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2013Q2), lags(1/4)
fcast compute p0037_, step(1)
fcstats D1.rgdp p0037_D_rgdp
* var 57:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2013Q2), lags(1/5)
...
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2013Q2), lags(1/5)
...
* var 60
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2013Q2), lags(1/3)
...
* var 55: lag test say 5 best. Model stable, serial correlation not a big problem
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2013Q4), lags(1/5)
fcast compute p00360_, step(1)
fcstats D1.rgdp p00360_D_rgdp
* var 56: : lag test say 12 is best but that seems a bit much and gives an error. Model is stable at 4 lags and 5 lags, serial correlation not problem
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario  if qdate<tq(2013Q4), lags(1/3)
fcast compute p00370_, step(1)
fcstats D1.rgdp p00370_D_rgdp
* var 57:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario  if qdate<tq(2013Q4), lags(1/4)
fcast compute p00380_, step(1)
fcstats D1.rgdp p00380_D_rgdp
* var 58: lag test say 12 is best but that seems a bit much and gives an error. Model is stable at 4 lags, 5 and 6 lags, serial correlation not problem
qui var D1.rgdp D1.pib D1.primario  if qdate<tq(2013Q4), lags(1/5)
fcast compute p00390_, step(1)
fcstats D1.rgdp p00390_D_rgdp
* var 59
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2013Q4), lags(1/3)
...
* h =1 
* VAR 86:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.fbcf if qdate<tq(2014Q4), lags(1/4)
...
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2014Q4), lags(1/5)
...
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2014Q4), lags(1/3)
fcast compute p003700_, step(1)
fcstats D1.rgdp p003700_D_rgdp
* var 89:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2014Q4), lags(1/4)
...
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2014Q4), lags(1/5)
fcast compute p003900_, step(1)
fcstats D1.rgdp p003900_D_rgdp
* var 91
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2014Q4), lags(1/3)
...
* h =1 
* VAR 54:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.fbcf if qdate<tq(2015Q4), lags(1/4)
fcast compute p0035000_, step(1)
fcstats D1.rgdp p0035000_D_rgdp
* var 55: lag test say 5 best. Model stable, serial correlation not a big problem
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2015Q4), lags(1/5)
fcast compute p0036000_, step(1)
fcstats D1.rgdp p0036000_D_rgdp
* var 56: : lag test say 12 is best but that seems a bit much and gives an error. Model is stable at 4 lags and 5 lags, serial correlation not problem
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2015Q4), lags(1/3)
fcast compute p0037000_, step(1)
fcstats D1.rgdp p0037000_D_rgdp
* var 57:
qui var D1.rgdp D1.pib D1.manuf D1.serv D1.primario if qdate<tq(2015Q4), lags(1/4)
fcast compute p0038000_, step(1)
fcstats D1.rgdp p0038000_D_rgdp
* var 58: lag test say 12 is best but that seems a bit much and gives an error. Model is stable at 4 lags, 5 and 6 lags, serial correlation not problem
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2015Q4), lags(1/5)
fcast compute p0039000_, step(1)
fcstats D1.rgdp p0039000_D_rgdp
* var 59
qui var D1.rgdp D1.pib D1.primario if qdate<tq(2015Q4), lags(1/3)
