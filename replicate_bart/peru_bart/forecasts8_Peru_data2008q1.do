...
** SET 8 **
* var 50
qui var D1.rgdp D1.pib D1.cpi, lags(1/5)
* var 51
qui var D1.rgdp D1.pib D1.cpi, lags(1/4)
* var 52
qui var D1.rgdp D1.pib D1.fbcf D1.cpi, lags(1/5)
* var 53
qui var D1.rgdp D1.pib D1.fbcf D1.cpi, lags(1/4)
* var 54
...
* h =1 
* VAR 54:
qui var D1.rgdp D1.pib D1.cpi if qdate<tq(2013Q2), lags(1/5)
...
qui var D1.rgdp D1.pib D1.fbcf D1.cpi if qdate<tq(2013Q2), lags(1/5)
fcast compute p0037_, step(1)
fcstats D1.rgdp p0037_D_rgdp
* var 57:
qui var D1.rgdp D1.pib D1.fbcf D1.cpi if qdate<tq(2013Q2), lags(1/4)
...
* h =1 
* VAR 54:
qui var D1.rgdp D1.pib D1.cpi if qdate<tq(2013Q4), lags(1/5)
...
* var 56: : lag test say 12 is best but that seems a bit much and gives an error. Model is stable at 4 lags and 5 lags, serial correlation not problem
qui var D1.rgdp D1.pib D1.fbcf D1.cpi  if qdate<tq(2013Q4), lags(1/5)
fcast compute p00370_, step(1)
fcstats D1.rgdp p00370_D_rgdp
* var 57:
qui var D1.rgdp D1.pib D1.fbcf D1.cpi  if qdate<tq(2013Q4), lags(1/4)
...
* h =1 
* VAR 54:* period 3: 2014Q4

* h =1 
* VAR 86:
qui var D1.rgdp D1.pib D1.cpi if qdate<tq(2014Q4), lags(1/5)
...
qui var D1.rgdp D1.pib D1.fbcf D1.cpi if qdate<tq(2014Q4), lags(1/5)
fcast compute p003700_, step(1)
fcstats D1.rgdp p003700_D_rgdp
* var 89:
qui var D1.rgdp D1.pib D1.fbcf D1.cpi if qdate<tq(2014Q4), lags(1/4)
...
qui var D1.rgdp D1.pib D1.cpi if qdate<tq(2015Q4), lags(1/5)
...
* var 56: : lag test say 12 is best but that seems a bit much and gives an error. Model is stable at 4 lags and 5 lags, serial correlation not problem
qui var D1.rgdp D1.pib D1.fbcf D1.cpi if qdate<tq(2015Q4), lags(1/5)
fcast compute p0037000_, step(1)
fcstats D1.rgdp p0037000_D_rgdp
* var 57:
qui var D1.rgdp D1.pib D1.fbcf D1.cpi if qdate<tq(2015Q4), lags(1/4)
