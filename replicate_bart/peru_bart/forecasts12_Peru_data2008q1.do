...
** SET 12 **
* var 75
qui var D1.rgdp D1.pib D1.cpi D1.ri D1.primario, lags(1/4)
* var 74a
qui var D1.rgdp D1.pib D1.cpi D1.ri D1.primario, lags(1/2)
* var 74
qui var D1.rgdp D1.pib D1.cpi D1.ri D1.primario, lags(1/5)
* var 72
qui var D1.rgdp D1.pib D1.cpi D1.fbcf D1.primario, lags(1/5)
* var 73
qui var D1.rgdp D1.pib D1.cpi D1.fbcf D1.primario, lags(1/4)
* var 72a
qui var D1.rgdp D1.pib D1.cpi D1.fbcf D1.primario, lags(1/2)
* var 73a
qui var D1.rgdp D1.pib D1.cpi D1.fbcf D1.primario, lags(1/3)
...
* var 74a
qui var D1.rgdp D1.pib D1.cpi D1.ri D1.primario, lags(1/2)
fcast compute pVAR74a_, step(6)
fcast graph pVAR74a_D_rgdp, observed

* var 72a
qui var D1.rgdp D1.pib D1.cpi D1.fbcf D1.primario, lags(1/2)
fcast compute pVAR72a_, step(6)
fcast graph pVAR72a_D_rgdp, observed
